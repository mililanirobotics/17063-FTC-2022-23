...
@Autonomous(name="Official Auto Left")
public class OfficialAutoLeft extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (currentSignal.equals("Trojan")) {
            ...
            encoderDrive.operate(this, 0.25, 4, "right", telemetry);
            encoderDrive.operate(this, 0.25, 12.1, "backward", telemetry);
        }
